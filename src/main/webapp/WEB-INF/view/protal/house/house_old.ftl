...
function loadData(){
	...
	load.post("/protal/house/old/list", postData, false, function(data) {
		if(data){
...
<div class="head">
    <a href="/protal/index" class="return"><i class="icon-chevron-left"></i> 返回</a>
   	 二手房资讯
    <a href="/protal/house/old/sign" class="search"><i class="icon-edit"></i> </a>
</div>
	...
	<div class="filter-tab-list" id="filter-tab-list">
		...
		<div class="list-area list-area-price" id="tab_price">
			<ul>
				...
				<li><a href="#" data-value="1">50万元以下</a></li>
				<li><a href="#" data-value="2">50-100万元</a></li>
				<li><a href="#" data-value="3">100-200万元</a></li>
				<li><a href="#" data-value="4">200-500万元</a></li>
				<li><a href="#" data-value="5">500万元以上</a></li>
			</ul>
		</div>
		<!--房型-->
...
<script id="list-template" type="text/x-handlebars-template">
	{{#each this}}
	<li>
		<a href="/protal/house/old/detail/{{id}}" class="house-link"></a>
		<div class="con">
            ...
            <div class="house-detail">
                ...
                <div class="house-price">
                	<span class="price-total">{{price}}万元</span>

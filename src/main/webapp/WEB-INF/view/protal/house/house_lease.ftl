...
function loadData(){
	...
	load.post("/protal/house/lease/list", postData, false, function(data) {
		if(data){
...
<div class="head">
    <a href="/protal/index" class="return"><i class="icon-chevron-left"></i> 返回</a>
   	 出租房资讯
    <a href="/protal/house/lease/sign" class="search"><i class="icon-edit"></i> </a>
</div>
	...
	<div class="filter-tab-list" id="filter-tab-list">
		...
		<div class="list-area list-area-price" id="tab_price">
			<ul>
				...
				<li><a href="#" data-value="1">1000元/月以下</a></li>
				<li><a href="#" data-value="2">1000-3000元/月</a></li>
				<li><a href="#" data-value="3">3000-5000元/月</a></li>
				<li><a href="#" data-value="4">5000-1万元/月</a></li>
				<li><a href="#" data-value="5">1万元/月以上</a></li>
			</ul>
		</div>
		<!--房型-->
...
<script id="list-template" type="text/x-handlebars-template">
	{{#each this}}
	<li>
		<a href="/protal/house/lease/detail/{{id}}" class="house-link"></a>
		<div class="con">

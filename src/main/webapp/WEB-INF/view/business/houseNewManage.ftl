...
<script type="text/javascript" src="${request.contextPath}/static/js/business/houseNewManage.js"></script>
</head> 
<body class="layer-body">
<div class="container easyui-layout" data-options="fit:true">
    <table id="dg" class="easyui-datagrid" style="width:100%;height:100%" title="新房列表" data-options="rownumbers:true,singleSelect:false,
    autoRowHeight:true,pagination:true,pageSize:10,fitColumns:false,striped:true,nowrap:false,toolbar:'#tb'">
        <thead>
            <tr>
                ...
                <th field="price" width="80" align="center" formatter="FormatterPrice">房屋预计单价</th>
                <th field="purpose" width="80" align="center">房屋用途</th>
    ...
    <div id="tb" style="padding:0 20px;">
	    ...
	    <div class="opt-buttons">
		        <a href="#" class="easyui-linkbutton" iconCls="icon-edit" onclick="editNewHouseStatus(0)">启用</a>
		        <a href="#" class="easyui-linkbutton" iconCls="icon-edit" onclick="editNewHouseStatus(1)">下架</a>

...
<script type="text/javascript" src="${request.contextPath}/static/js/business/houseLeaseManage.js"></script>
</head> 
<body class="layer-body">
<div class="container easyui-layout" data-options="fit:true">
    <table id="dg" class="easyui-datagrid" style="width:100%;height:100%" title="出租房列表" data-options="rownumbers:true,singleSelect:false,
    ...
    <div id="tb" style="padding:0 20px;">
	    ...
	    <div class="opt-buttons">
		        <a href="#" class="easyui-linkbutton" iconCls="icon-edit" onclick="editLeaseHouseStatus(0)">启用</a>
		        <a href="#" class="easyui-linkbutton" iconCls="icon-edit" onclick="editLeaseHouseStatus(1)">下架</a>

...
public class DateUtil {
	 ...
	 * @return
	 */
	public static String getDayByMin() {
	...
	public static Date parseMitureTime(String date) {
	...
	public static boolean isNumBeteen(Date addtime, Integer n){
		...
		Date now = new Date();
		if(beforeDay.getTime() < now.getTime()){
			return true;
		}else{
			return false;
		}
